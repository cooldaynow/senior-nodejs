...
- [x] **Проектирование REST API**
  ...
  - [x] Принципы REST, уровни зрелости (Richardson Maturity Model).
  - [x] Версионирование API (v1, v2).

- [x] **Оптимизация запросов**

  - [x] HTTP/2 (мультиплексирование, сжатие заголовков).
  - [x] Кэширование (ETag, Last-Modified, Cache-Control).

- [x] **Rate Limiting и защита от DDoS**
  - [x] `express-rate-limit`, Redis, NGINX.

> **Задача**:
>
> - [x] Создать REST API (например, для управления пользователями) с версионированием.
